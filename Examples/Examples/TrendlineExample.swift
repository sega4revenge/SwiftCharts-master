...
class TrendlineExample: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let chartPoints: [ChartPoint] = [(1, 15205), (2, 5000), (3, 25000), (4, 6400), (5, 2800), (6, 18000)].map{ChartPoint(x: ChartAxisValueDouble($0.0, labelSettings: labelSettings), y: ChartAxisValueDouble($0.1))}
